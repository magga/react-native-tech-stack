export default () => {
    return [
        ...
        },
        {
            id: 6,
            title: 'ESLint',
            description: 'ESLint is an open source JavaScript linting utility originally created by Nicholas C. Zakas in June 2013. Code linting is a type of static analysis that is frequently used to find problematic patterns or code that doesnt adhere to certain style guidelines.'
        },
        {
            id: 7,
            title: 'Babel',
